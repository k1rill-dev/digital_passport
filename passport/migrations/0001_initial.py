    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('face', models.ImageField(blank=True, default='Нет картинки', null=True, upload_to='face_of_user/%Y/%m/%d/', verbose_name='Лицо')),
                ...
                ('number_of_phone', models.IntegerField(max_length=11, verbose_name='Номер телфона')),
