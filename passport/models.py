...
class User(AbstractUser):
    face = models.ImageField(upload_to='face_of_user/%Y/%m/%d/', blank=True, null=True,
                             verbose_name='Лицо')
    date_of_birthday = models.CharField(max_length=40, verbose_name='Дата рождения', blank=True, null=True)
    ...
    number_of_phone = models.CharField(max_length=12, verbose_name='Номер телфона', blank=True, null=True)
